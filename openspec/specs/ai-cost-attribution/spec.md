# ai-cost-attribution Specification

## Purpose
Define how AI Market Studio attributes LLM requests, token usage, and cost to low-cardinality business dimensions while preserving gateway-sourced cost accounting and avoiding duplicate cost totals.
